...
const Footer = () => {
  ...
  <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
    {/* <!-- Brand --> */}
    <div>
      <h1 class="text-2xl font-bold text-white mb-3">ProductVerse</h1>
      <p class="text-sm">Your one-stop platform for amazing tech products. Submit, upvote, and discover the future.</p>
    </div>
    ...
    <div>
      ...
      <ul class="space-y-1">
        <li><a href="#" class="hover:underline">Trending</a></li>
        <li><a href="#" class="hover:underline">New</a></li>
        <li><a href="#" class="hover:underline">Submit Product</a></li>
      </ul>
    </div>
  ...
  <div class="mt-10 border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center">
    <p class="text-sm">&copy; 2025 ProductVerse. All rights reserved.</p>
